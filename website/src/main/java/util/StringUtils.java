...
public class StringUtils {
	...
	// Start: Validation Messages
		...
		public static final String GET_PRODUCT_DETAILS = "SELECT productID,productName,productPrice,productStock,productCategory,productDescription FROM product";
		...
		public static final String SELECT_PRODUCT_BY_ID = "SELECT productID,productName,productPrice,productStock,productCategory,productDescription,imagePart FROM product WHERE productID = ?";
